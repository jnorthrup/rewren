...
// Helper component to apply reasoning styling (dim + italic)
const ReasoningText: React.FC<{ children: React.ReactNode; isReasoning: boolean }> = ({
  children,
  isReasoning,
}) => {
  if (isReasoning) {
  ...
  lines.forEach((line, index) => {
    ...
    if (codeFenceMatch) {
      ...
      if (
        ...
        addContentBlock(
          <Box key={key}>
            <ReasoningText isReasoning={isReasoning}>
              <Text wrap="wrap">
