...
This command activates the Business Analyst agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/analyst.md](bmad/bmm/agents/analyst.md)
