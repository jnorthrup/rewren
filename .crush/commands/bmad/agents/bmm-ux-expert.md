...
This command activates the UX Expert agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/ux-expert.md](bmad/bmm/agents/ux-expert.md)
