...
This command activates the Master Test Architect agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/tea.md](bmad/bmm/agents/tea.md)
